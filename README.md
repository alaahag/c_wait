...
- <h5>PenetrationTesting:</h5>
<h5>1. You have logged into a foreign system, And you want to "scan the area" with the current installed methods in that machine (to make no suspicious noise there).</h5>  
<h5>2. View the installed methods in X machine to get a clean vision of what could Hackers do inside your system (if they can compile or evaluate scripts using the existing methods, Then they can do some dangerous stuff there).</h5>
