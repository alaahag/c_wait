...
>2. In addition, Full support for: _BusyBox, Termux, macOS, RedHat, SUSELinux, ArchLinux, Mageia, GentooLinux, Endless, OpenBSD, FreeBSD, Solus, Guix, Slackware_ and other Linux distributions.  
...
- <h5>No support for Solaris OS (incompatible version of 'grep').</h5>  
